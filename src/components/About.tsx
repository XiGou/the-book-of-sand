...
const content = {
  ...
  ar: {
    title: 'حول كتاب الرمال',
    intro: '«كتاب الرمال» قصة قصيرة لبورخيس. يحصل الراوي من بائع أناجيل على كتاب مقدس لا بداية له ولا نهاية؛ يتملكه تدريجياً قلق من لانهايته وعدم إمكانية الإحاطة به، وفي النهاية يخفيه في قبو المكتبة الوطنية.',
    back: 'رجوع',
    section1Title: 'ما هو الكتاب',
    section1Lead: 'يشرح الغريب اسم الكتاب وبنيته:',
    quote1: '«أخبرني أن كتابه يسمى كتاب الرمال، لأن الكتاب ولا الرمال لا بداية ولا نهاية له.»',
    quote2: '«عدد صفحات هذا الكتاب لا يزيد ولا ينقص عن اللانهاية. لا توجد صفحة أولى، ولا صفحة أخيرة. لا أعرف لماذا رُقِّمت بهذه الطريقة الاعتباطية. ربما للإيحاء بأن حدود متتالية لا نهاية لها يمكن أن تأخذ أي رقم.»',
    quote3: '«انظر إلى الرسم بعناية. لن ترى هذا الرسم مرة أخرى.»',
    section2Title: 'الاستعارات',
    section2Lead: 'يشير بورخيس إلى الاستعارة عبر جورج هربرت والغريب:',
    epigraph: '«…حبلكَ من الرمال…» — جورج هربرت',
    quote4: '«إذا كان الفضاء لا نهاية له، فقد نكون في أي نقطة من الفضاء. وإذا كان الزمن لا نهاية له، فقد نكون في أي لحظة من الزمن.»',
    quote5: '«شعرت أن الكتاب كان شيئاً كابوسياً، شيئاً فاضحاً يعتدي على الواقع ذاته ويلوثه.»',
    quote6: '«أفضل مكان لإخفاء ورقة هو الغابة.»',
    section3Title: 'التجليات',
    section3Lead: 'تكشف وضع الراوي وخياره:',
    revelation1: 'لا يمكن امتلاك اللانهاية أو استنفادها—في محاولة امتلاكها، يصبح المرء «سجيناً للكتاب»؛ «لن ترى هذا الرسم مرة أخرى» يشير إلى أن كل قراءة فريدة ولا تتكرر.',
    revelation2: 'في متتالية لا نهائية، قد يظهر أي حد: مكان المرء في الزمان والمكان ليس سوى نقطة في اللانهاية، بلا امتياز وبلا نهاية.',
    revelation3: 'في مواجهة لانهاية غير مفهومة وغير قابلة للتدمير، لا يمكن للراوي إلا إخفاؤها مجدداً في غابة المعرفة—المكتبة—محوها من حياته دون محوها من العالم.',
  },
  he: {
    title: 'אודות ספר החול',
    intro: '«ספר החול» הוא סיפור קצר של בורחס. הסופר-מספר קונה ממוכר תנ"כים ספר קדוש שאין לו לא תחילה ולא סוף; הוא נסחף בהדרגה בחרדה מאינסופיותו ומאי-יכולת ההשגה שלו, ולבסוף מסתיר אותו במרתף הספרייה הלאומית.',
    back: 'חזרה',
    section1Title: 'מהו הספר',
    section1Lead: 'הזר מסביר את שם הספר ומבנהו:',
    quote1: '«הוא אמר לי שהספר שלו נקרא ספר החול, כי לא לספר ולא לחול יש תחילה או סוף.»',
    quote2: '«מספר הדפים בספר הזה אינו גדול ולא קטן מאינסוף. אין דף ראשון, אין דף אחרון. אינני יודע מדוע הם ממוספרים בדרך שרירותית זו. אולי כדי לרמוז שהאיברים של סדרה אינסופית יכולים לקחת כל מספר.»',
    quote3: '«הסתכל היטב על האיור. לעולם לא תראה אותו שוב.»',
    section2Title: 'מטאפורות',
    section2Lead: 'בורחס מצביע על המטאפורה דרך ג\'ורג\' הרברט והזר:',
    epigraph: '«…חבלי חולך…» — ג\'ורג\' הרברט',
    quote4: '«אם המרחב הוא אינסופי, אנו עשויים להיות בכל נקודה במרחב. אם הזמן הוא אינסופי, אנו עשויים להיות בכל נקודה בזמן.»',
    quote5: '«הרגשתי שהספר היה חפץ-סיוט, דבר מגעיל שפגע במציאות עצמה ולכלך אותה.»',
    quote6: '«המקום הטוב ביותר להסתיר עלה הוא ביער.»',
    section3Title: 'התגלויות',
    section3Lead: 'מצבו ובחירתו של המספר מגלים:',
    revelation1: 'לא ניתן להחזיק את האינסוף או לרוקן אותו—בניסיון להחזיק בו, הופך אחד ל«שבוי של הספר»; «לעולם לא תראה אותו שוב» מרמז שכל קריאה היא יחידאית ובלתי-חוזרת.',
    revelation2: 'בסדרה אינסופית, כל איבר יכול להופיע: מקומו של אחד בזמן ובמרחב הוא רק נקודה בתוך האינסוף, ללא יתרון וללא סוף.',
    revelation3: 'מול אינסוף בלתי-מובן ובלתי-ניתן לחיסול, המספר יכול רק להסתיר אותו שוב ביער הידע—הספרייה—ולמחוק אותו מחייו אך לא מהעולם.',
  },
} as const
  ...
  return (
    <div
      ...
      style={{
        ...
        fontFamily: lang === 'ar' ? 'var(--font-serif-ar)' : lang === 'he' ? 'var(--font-serif-he)' : undefined,
      }}
    >
